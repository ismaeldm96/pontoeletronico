...
@section('adminlte_css')
    ...
    <link rel="stylesheet" href="{{ asset('vendor/adminlte/dist/css/pontoeletronico.css') }}">
            ...
            <nav class="navbar navbar-static-top">
                <div class="container">
                    <div class="navbar-header">
                        <a style="padding: 5px 15px" href="{{ url(config('adminlte.dashboard_url', 'home')) }}" class="navbar-brand">
